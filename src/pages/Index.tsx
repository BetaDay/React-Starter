        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">All properties are thoroughly verified and inspected for quality</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Join thousands of satisfied tenants and landlords</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Find and secure your property in just a few clicks</p>
            </div>
          </div>
        </div>
      </section>
